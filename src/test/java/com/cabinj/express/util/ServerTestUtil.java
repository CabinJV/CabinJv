package com.cabinj.express.util;
...
public class ServerTestUtil {
    ...
    /**
     * Makes a simple HTTP GET request and returns the response body
     */
    public static String makeHttpRequest(String url) throws Exception {
        HttpURLConnection connection = (HttpURLConnection) new URL(url).openConnection();
        connection.setRequestMethod("GET");
        connection.setConnectTimeout(5000);
        connection.setReadTimeout(10000); // Allow longer read timeout for slow endpoints
